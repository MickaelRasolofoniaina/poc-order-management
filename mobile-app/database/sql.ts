export const INIT_DATABASE_SQL = `
    ...
    CREATE TABLE IF NOT EXISTS CUSTOMER (
        CustomerId INTEGER PRIMARY KEY NOT NULL AUTOINCREMENT,
        CompanyName TEXT,
        ContactName TEXT,
        Address TEXT,
        City TEXT,
    ...
    CREATE TABLE IF NOT EXISTS ORDER (
        OrderId INTEGER PRIMARY KEY NOT NULL AUTOINCREMENT,
    ...
    CREATE TABLE IF NOT EXISTS DETAIL_ORDER (
        DetailOrderId INTEGER PRIMARY KEY NOT NULL AUTOINCREMENT,
